...
@WebService(serviceName = "getKPIValue",targetNamespace = "http://webservice",endpointInterface = "webservice.I6000WebService")
@Component
public class I6000WebServiceImpl extends DsbaseController implements I6000WebService {

    @Resource
    public I6000Service i6000Service;

    @Override
    public void getKPIValue(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse,String corporationCode, String time, String names) {
        logger.info("I6000传入参数：编号：" + corporationCode + "时间"  + time + "KPIValue" + names);
...
//                            kpiNameMap.put("BusinessSystemRunningTime",(presentTime - startTime) / 1000);
        ...
        writeSuccessResultI6000(httpServletRequest,httpServletResponse,responseMap);
    }
